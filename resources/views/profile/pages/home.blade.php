    ...
    <div class="container">
        <div class="hero-content">
            <div class="hero-text">
                ...
                <p class="hero-description">Votre partenaire santé de confiance à Abidjan. Nous vous accompagnons au quotidien avec des conseils personnalisés et des produits de qualité.</p>
        ...
        <div class="produits-grid">
            <div class="produit-card">
                <div class="produit-image">
                    <div class="produit-badge">Nouveau</div>
                </div>
                <div class="produit-content">
                    <h3>Médicaments Génériques</h3>
                    <p>Médicaments de qualité à prix accessibles</p>
            ...
            <div class="produit-card">
                ...
                <div class="produit-content">
                    ...
                    <p>Vitamines et suppléments nutritionnels</p>
                    <a href="#" class="produit-link">Découvrir →</a>
                </div>
            </div>
            <div class="produit-card">
                ...
                <div class="produit-content">
                    ...
                    <p>Soins de la peau et produits cosmétiques</p>
                    <a href="#" class="produit-link">Découvrir →</a>
                </div>
            </div>
            <div class="produit-card">
                ...
                <div class="produit-content">
                    ...
                    <p>Équipements et dispositifs médicaux</p>
                    <a href="#" class="produit-link">Découvrir →</a>
                </div>
            </div>
            <div class="produit-card">
                ...
                <div class="produit-content">
                    <h3>Hygiène & Santé</h3>
                    <p>Produits d'hygiène quotidienne</p>
                    <a href="#" class="produit-link">Découvrir →</a>
                </div>
            </div>
        </div>
        ...
        <div class="contact-grid">
            <div class="contact-info">
                <div class="info-card">
                    ...
                    <div>
                        <h3>Adresse</h3>
                        <p>Abidjan, Côte d'Ivoire<br>Quartier St Raymond</p>
                    </div>
                </div>
                <div class="info-card">
                    <div class="info-icon">
                    ...
                    <div>
                        <h3>Téléphone</h3>
                        <p>+225 27 XX XX XX XX<br>+225 07 XX XX XX XX</p>
                    </div>
                </div>
                <div class="info-card">
                    <div class="info-icon">
...
<section class="garde-section" id="garde">
    <div class="container">
        <div class="garde-content">
            ...
            <a href="tel:+22527000000" class="btn btn-primary">Appeler maintenant</a>
        </div>
    </div>
</section>
@endsection