                            ...
                            <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                ...
                                <div class="pt-0">
                                    ...
                                    <div class="text-center text-muted mb-4">
                                        <p class="mb-0">Pas de compte ?<a class='text-primary ms-2 fw-medium' href="{{ route('register') }}">Creer un compte</a></p>
                                    </div>

                                    <div class="row">
                                        <div class="col-12">
                                            <a href="{{ url('/auth/google') }}" class="btn text-dark border fw-normal d-flex align-items-center justify-content-center mb-3">
                                        ...
                                        <div class="col-12">
                                            <a href="{{ url('/auth/facebook') }}" class="btn btn-primary fw-normal d-flex align-items-center justify-content-center mb-3">
                                        ...
                                        <div class="col-12">
                                            <a href="{{ url('/auth/apple') }}" class="btn btn-dark fw-normal d-flex align-items-center justify-content-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="me-2">
