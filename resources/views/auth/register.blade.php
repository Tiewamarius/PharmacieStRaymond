...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset("Backendtheme/assets/images/icons8-online-pharmacy-64.png")}}">
                                ...
                                <div class="pt-0">
                                    <form method="POST" action="{{route('register')}}" class="my-4">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="username" class="form-label">Nom(Ou nom complet)</label>
                                            <input class="form-control" name="name" type="text" id="username" required="" placeholder="Enter your Username">
                                        ...
                                        <div class="form-group d-flex mb-3">
                                            <div class="col-12">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="checkbox-signin">Accepter les <a href="#" class="text-primary fw-medium"> Termes & Conditions</a></label>
                                                </div>
                                            </div><!--end col-->
                                        </div>
                                    ...
                                    <div class="text-center text-muted mb-4">
                                        <p class="mb-0">Deja inscrit ?<a class='text-primary ms-2 fw-medium' href='{{ route('login') }}'>Connectez-Vous</a></p>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <a href="{{ url('/auth/google') }}" class="btn btn-primary fw-normal d-flex align-items-center justify-content-center mb-3">
                                        ...
                                        <div class="col-12">
                                            <a href="{{ url('/auth/facebook') }}" class="btn btn-dark fw-normal d-flex align-items-center justify-content-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="me-2">
                ...
                <div class="col-xl-7">
                    <div class="account-page-bg p-md-5 p-4">
                        <div class="text-center">
                            <h3 class="text-dark mb-3 pera-title">Rapide, efficace et productif à la Pharmacie St Raymond</h3>
                            <div class="auth-image">
                                <img src="{{ asset('Img/Photo-Pharmacie.jpg') }}" class="mx-auto img-fluid" alt="images">
                            </div>
                        </div>
                    </div>
                </div>
